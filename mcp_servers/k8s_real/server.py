...
async def configure_cluster(kubeconfig_content: str) -> str:
    ...
    """
    try:
        logger.info("🔧 Received request to configure cluster with new kubeconfig")
        ...
        if v1:
             msg = "✅ Cluster configured successfully! Connection established."
        else:
             msg = "⚠️ Configuration applied, but connection verification failed."
